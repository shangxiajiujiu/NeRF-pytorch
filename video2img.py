...
# 全局变量
VIDEO_PATH = 'D:/gongju/COLMAP-3.9.1-windows-cuda/project/road/road.mp4'  # 视频地址
EXTRACT_FOLDER = 'D:/gongju/COLMAP-3.9.1-windows-cuda/project/road/road.mp4'  # 存放帧图片的位置
